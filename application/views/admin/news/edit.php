            ...
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <?php $catalogurl = $this->catalognew_model->get_info($info->catalog_id)->url; ?>
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= site_url($catalogurl . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
