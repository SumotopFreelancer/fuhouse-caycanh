...
$route['admin/catalog/(:num)'] = 'admin/catalog/index/$1'; // Danh mục tin tức cha
$route['admin/catalog'] = 'admin/catalog/index'; // Danh sách
$route['admin/products/(:num)'] = 'admin/products/index/$1'; // Tin tức
$route['admin/products'] = 'admin/products/index'; // Danh sách
...
// Sản phẩm
$route[_csp . '/(:any)/(:num)'] = 'products/catalog/$1/$2'; // Danh mục phân trang
$route[_csp . '/(:any)'] = 'products/catalog/$1'; // Danh mục
...
// Bài viết
$route['(:any)/(:num)'] = 'news/catalog/$1/$2'; // Danh mục phân trang
$route['(:any)/(:any)'] = 'news/view/$2';
$route['(:any)'] = 'news/catalog/$1'; // Danh mục
